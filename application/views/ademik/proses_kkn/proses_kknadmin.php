      ...
      <div class="row">
        <div class="col-12">
         ...
         <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form class="form-horizontal" action="<?php echo base_url().'ademik/proses_kkn/proses_kknadmin/daftar' ?>" method="POST">
               <div class="form-group row">
                <label class="col-sm-1 control-lebel">Masukkan NIM :</label>
                    ...
                    <div class="col-sm-2">
                      <input class="btn btn-flat btn-info" type="submit" id="search" name="search" value="Daftar">
                    </div>
                </div>
              </form>
             </div>
