			...
			<div class="col-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Edit Admin Fakultas</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
						...
						?>
						<form action="<?= base_url('ademik/useraccess/updateAdminFak/'.$edit->ID); ?>" method="POST">
								...
								<select class="form-control" id="KodeFakultas" name="KodeFakultas">
									<?php
										foreach ($fakultas as $show) {
											$selected="";
											if($edit->KodeFakultas==$show->Kode){
												$selected="selected";
											}
									?>
										<option value="<?= $show->Kode; ?>" <?= $selected; ?>><?= $show->Kode." - ".$show->Singkatan; ?></option>
									<?php
										}
									?>
								</select>
							...
							<div class="form-group row">
								<div class="col-md-12" style="text-align: center;">
									...
									<a href="<?= base_url('ademik/useraccess/adminfak'); ?>" class="btn btn-danger">Kembali</a>
								</div>
							</div>	
						</form>
					</div>
