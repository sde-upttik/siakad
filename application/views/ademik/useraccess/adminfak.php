<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Halaman Management Admin Fakultas
		</h1>
		<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Management User Admin Fakultas</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
							if($this->session->ulevel==1){
								echo '<a href="'.base_url('ademik/useraccess/addadminfak').'" class="btn btn-flat btn-success" style="margin-bottom: 20px;">Tambah Admin Fakultas</a>';
							}
						?>
