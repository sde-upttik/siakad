			...
			<div class="col-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Edit Admin Pusat</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
						...
						?>
						<form action="<?= base_url('ademik/useraccess/updateAdminPusat/'.$edit->ID); ?>" method="POST">
							...
							<div class="form-group row">
								<div class="col-md-12" style="text-align: center;">
									...
									<a href="<?= base_url('ademik/useraccess/adminpusat'); ?>" class="btn btn-danger">Kembali</a>
								</div>
							</div>	
						</form>
					</div>
