<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Halaman Management Admin Dosen
		</h1>
		<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Management User Admin Dosen</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
							if($this->session->ulevel==1){
								echo '<a href="'.base_url('ademik/useraccess/addadmindosen').'" class="btn btn-flat btn-success" style="margin-bottom: 20px;">Tambah Admin Dosen</a>';
							}
						?>
