			...
			<div class="col-12">
				<div class="box">
					...
					<div class="box-body">
						...
						?>
						<form action="<?= base_url('ademik/useraccess/updateAdminMahasiswa/'.$edit->ID); ?>" method="POST">
							...
							<div class="form-group row">
							  ...
							  <div class="col-md-6">
								<input class="form-control" type="text" id="nim" name="nim" value="<?= $edit->NIM; ?>" readonly>
							  </div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<div class="col-md-12" style="text-align: center;">
									...
									<a href="<?= base_url('ademik/useraccess/mahasiswa'); ?>" class="btn btn-danger">Kembali</a>
								</div>
							</div>	
						</form>
					</div>
