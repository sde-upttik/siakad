...
// fandu rubah $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel = 9;
...
class nusoap_base {
	...
	*/
	function nusoap_base() {
		// fandu rubah $this->debugLevel = $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel;
	...
	*/
	function getGlobalDebugLevel() {
		// fandu rubah return $GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel;
	...
	*/
	function setGlobalDebugLevel($level) {
		// fandu rubah$GLOBALS['_transient']['static']['nusoap_base']->globalDebugLevel = $level;
	...
	*/
	function setEncoding($enc='gzip, deflate') {
		if (function_exists('gzdeflate')) {
			...
			// fandu rubah text di bawah dari set_magic_quotes_runtime(0); ke @set_magic_quotes_runtime(0);
...
class nusoap_client extends nusoap_base  {
	...
	*/
	...
	function loadWSDL() {
		...
		//fandu rubah text di bawah dari tanda =& jadi =
